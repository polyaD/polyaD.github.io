---
title:  Perl Mr.How To deeply Understanding Perl Code Model
layout: post
categories: softwaredomain
tags: Perl
excerpt: perl code Item module
---
   

#Perl Mr.How To deeply Understanding Perl Code Model <span id="home">  
polyaD，origin link<https://polyad.github.io/tags>      
Any question ,please contact to me ,polyaluthor@gmail.com，or wechat:polyad ,qq group:282642152

- Idea 
- Logic outline
   - 1. background information: author, contact information, update time, version, main functions, main implementation logic, use examples, run method
   - 2. main program: contains the standard library information, perl template, function function implementation, main program, call processing information
   - 3. Sub-module: external parameter input module, time running module, output module, input detection module, detection module, test module
   - 4. How to transfer data in an orderly and safe way? How is the data stored and processed?
   - 5. List of problems
